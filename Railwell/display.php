		...
		<div class="span12 well">
			...
			<div >
				...
				<tr class="text-error">
					...
					<th style="width:100px;"><a href="checkout.php?Tnumber=<?php echo $row['Tnumber'];?>&doj=<?php echo $row['doj'];?>&fromstn=<?php echo $row['fromstn']; ?>&tostn=<?php echo $row['tostn']; ?>&DOB=<?php echo $row['DOB'];?>">PAY </a> </th>
				</tr>
				<?php 
					}
					else
